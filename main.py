    ...
    for model in models:
        if (model == "1"):
            for review_type in review_types:
                if review_type == "a":
                    return create_review_with_trigrams(reviews_string.split(), avg_review_len, title, avg_score)
                elif review_type == "p":
                    return create_review_with_trigrams(positive_reviews_string.split(), avg_positive_review_len, title, avg_positive_score)
                elif review_type == "n":
                    return create_review_with_trigrams(negative_reviews_string.split(), avg_negative_review_len, title, avg_negative_score)
                else:
